...
- Load/Save: Use “Load Recipes” and “Save Recipes” to reuse your custom rules. These actions save everything needed to rebuild what you see in the preview into a recipe file.
  - Right‑click **Load SFC File** for a context menu: **Load from file…** opens the OS file picker as usual; **Load Preset: Beginner** or **Load Preset: Midgame to Endgame** loads one of the bundled presets after a confirmation prompt (your current setup will be replaced).
